...
public class ContractSchemaValidator {
    ...
    public static final String ACTION_PLAN_SCHEMA = "action-plan.schema.json";
    public static final String FEEDBACK_SCHEMA = "feedback.schema.json";
    public static final String PROCESSED_INSIGHT_SCHEMA = "processed-insight.schema.json";
